...
import { deleteAuthor, getAuthors } from "../../../service/authors";
...
export default function AdminAuthors() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const auhtorsData = await getAuthors();
                      ...
                      <td className="px-4 py-3 flex items-center justify-end relative">
                        ...
                        {openDropDownId === author.id && (
                          <div
                            ...
                            className="absolute right-2 mt-2 z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
